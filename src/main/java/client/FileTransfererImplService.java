 ...
 * 
 */
@WebServiceClient(name = "FileTransfererImplService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:9898/codejava/fileService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FILETRANSFERERIMPLSERVICE_QNAME = new QName("http://service/", "FileTransfererImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9898/codejava/fileService?wsdl");
    ...
    public FileTransfererImpl getFileTransfererImplPort() {
        return super.getPort(new QName("http://service/", "FileTransfererImplPort"), FileTransfererImpl.class);
    }
    ...
    public FileTransfererImpl getFileTransfererImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "FileTransfererImplPort"), FileTransfererImpl.class, features);
    }
